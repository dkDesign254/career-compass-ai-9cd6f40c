    ...
    <AppShell>
      <div className="mx-auto max-w-5xl space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Full editing & deletion powers across the platform. Every write is audit-logged.</p>
        </div>
            ...
            <Link key={t.to} to={t.to} className="group">
              <Card className="h-full transition-colors group-hover:border-coral">
                <CardContent className="flex items-start gap-3 p-5">
                  <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand/10 text-brand"><t.icon className="h-5 w-5" /></span>
                  <div>
