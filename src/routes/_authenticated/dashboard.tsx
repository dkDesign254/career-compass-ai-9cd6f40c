                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Takes ~3 minutes. Unlocks matching and scoring.
                    </p>
                  </div>
                </div>
        ...
        <aside className="space-y-6">
          <Card>
            <CardContent className="space-y-3 p-4">
              <div className="flex items-center gap-2 text-sm font-medium">
                <Sparkles className="h-4 w-4 text-primary" /> First time here?
              </div>
              <p className="text-sm text-muted-foreground">
                Take a 60-second tour of how CareerPilot works.
              </p>
          ...
          <div>
            <div className="mb-2 flex items-center gap-2 text-sm font-medium">
              <Briefcase className="h-4 w-4" /> Your applications
            </div>
            {apps.length === 0 ? (
              <p className="text-sm text-muted-foreground">
                Nothing yet. Apply to a role and it lands here.
              </p>
            ) : (
            ...
            {notes.length === 0 ? (
              ...
              <ul className="space-y-2">
                {notes.map((n: any) => (
                  <li
                    key={n.id}
                    className={`rounded-md border p-3 text-sm ${n.read_at ? "opacity-70" : ""}`}
                  >
          ...
          <div className="rounded-md border p-4">
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li>
                <Link to="/skill-gap" className="text-primary hover:underline">
              ...
              <li>
                <Link to="/employability" className="text-primary hover:underline">
