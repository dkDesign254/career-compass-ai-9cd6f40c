  ...
  head: () => ({
    meta: [
      { title: "CareerPilot, where Africa's next generation launches their career" },
      {
        name: "description",
        content:
          "Discover thousands of jobs, internships, and employers. AI resume review, employability scoring, and personal matching built for students and graduates across Africa.",
      },
      { property: "og:title", content: "CareerPilot, launch your career" },
      {
        property: "og:description",
        content:
          "Thousands of live jobs and internships, AI resume review, and matched employers. Free for students and grads.",
      },
...
const TESTIMONIALS = [
  {
    ...
    quote:
      "The ATS score alone got my resume through three companies that had rejected me before. Landed my first remote role in six weeks.",
    img: t2,
  },
  {
    name: "Amina H.",
    role: "Product Marketing · Safaricom",
    quote:
      "I stopped guessing what recruiters wanted. CareerPilot showed me the skills to add and the roles that actually matched.",
    img: t3,
  },
  {
    name: "Brian M.",
    role: "Data Analyst · M-KOPA",
    quote:
      "Every morning I open one tab and see three roles I could apply to. It replaced five job boards and a spreadsheet.",
    img: t1,
  },
] as const;
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 border-b border-border/70 bg-background/95 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5">
          ...
          <nav className="hidden items-center gap-8 text-sm font-medium text-foreground/80 md:flex">
            ...
            <a href="#categories" className="transition-colors hover:text-accent">
              Explore
            </a>
            <a href="#employers" className="transition-colors hover:text-accent">
              Employers
            </a>
            <a href="#pillars" className="transition-colors hover:text-accent">
              For students
            </a>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 md:grid-cols-[1.1fr_1fr] md:gap-16 md:py-24 lg:py-28">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="font-display text-5xl font-semibold leading-[1.02] tracking-tight text-primary sm:text-6xl md:text-7xl">
              The career
              <br />
              network built for <span className="text-accent">you.</span>
            </h1>
            <p className="mt-7 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Thousands of jobs and internships across Africa and remote. AI resume review,
              employability scoring, and personal matching, all in one home for everything after
              graduation.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>
                  <b className="text-foreground">42,000+</b> students
                </span>
              </div>
              <div className="flex items-center gap-2">
                <Building2 className="h-4 w-4 text-accent" />
                <span>
                  <b className="text-foreground">1,200+</b> employers
                </span>
              </div>
              <div className="flex items-center gap-2">
                <TrendingUp className="h-4 w-4 text-accent" />
                <span>
                  <b className="text-foreground">6 weeks</b> avg. to hire
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-display text-lg font-semibold text-primary">
                    72 <span className="text-xs text-accent">+8 this week</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
            {EMPLOYERS.map((e) => (
              <span
                key={e}
                className="font-display text-lg font-semibold tracking-tight text-foreground/40 transition-colors hover:text-foreground/70"
              >
                {e}
              </span>
            ))}
        ...
        <div className="mx-auto max-w-7xl px-5">
          <div className="mb-10 flex items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-display text-4xl font-semibold tracking-tight text-primary">
                Find your path.
              </h2>
              <p className="mt-2 max-w-xl text-muted-foreground">
                Browse thousands of roles by field, from software to marketing, finance to design.
              </p>
            </div>
          </div>
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {CATEGORIES.map((c) => (
              <Link
                key={c.label}
                to="/auth"
                className="group relative block overflow-hidden rounded-2xl border border-border/60 ring-soft transition-transform hover:-translate-y-1"
              >
          ...
          {jobs && jobs.length > 0 ? (
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {jobs.map((j) => (
                <Link
                  key={j.id}
                  to="/auth"
                  className="group flex flex-col rounded-2xl border border-border bg-card p-5 transition-all hover:-translate-y-1 hover:border-accent/40 hover:shadow-md"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate font-display text-lg font-semibold leading-tight text-primary group-hover:text-accent">
                        {j.title}
                      </p>
                      <p className="mt-0.5 truncate text-sm text-muted-foreground">
                        {j.source ?? "Verified employer"}
                      </p>
                    </div>
                  </div>
                  {j.description && (
            ...
            <div className="rounded-2xl border border-dashed border-border/70 bg-secondary/40 p-10 text-center">
              <p className="font-display text-xl text-primary">
                The full board opens the moment you sign in.
              </p>
              <p className="mt-2 text-sm text-muted-foreground">
                Indexing BrighterMonday, Fuzu, MyJobMag, RemoteOK, WeWorkRemotely and company career
                pages every 12 hours.
              </p>
              <Button
                asChild
      ...
      <section id="pillars" className="border-b border-border/60 py-24">
        <div className="mx-auto max-w-7xl space-y-24 px-5">
          {[
            {
              kicker: "Employability score",
              title: "Know exactly where you stand.",
              body: "A weekly AI read across your skills, experience, and evidence, with clear next steps to raise it. No vanity metrics, no guessing.",
              image: catTech,
              reverse: false,
            },
            {
              kicker: "ATS resume review",
              title: "Get past the robots. Land the interview.",
              body: "Upload your resume in PDF or DOCX and get keyword-tuned rewrites in your voice. Built to pass the real ATS filters used by Safaricom, Andela, and 1,200+ employers.",
              image: catDesign,
              reverse: true,
            },
            {
              kicker: "Personal job matching",
              title: "Three great roles a day. Not three hundred.",
              body: "We match you to jobs by skill, location, and fit, then track every application in one pipeline. Shortlisted, interviewing, offered.",
              image: catMarketing,
              reverse: false,
            },
          ].map((p) => (
            <div
              key={p.kicker}
              className={`grid gap-10 md:grid-cols-2 md:items-center md:gap-16 ${p.reverse ? "md:[&>figure]:order-2" : ""}`}
            >
              ...
              <div>
                ...
                <h3 className="mt-3 font-display text-4xl font-semibold leading-tight tracking-tight text-primary">
                  {p.title}
                </h3>
        ...
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {TESTIMONIALS.map((t) => (
              <figure
                key={t.name}
                className="flex flex-col rounded-3xl border border-border bg-card p-6 ring-soft"
              >
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg text-white/80">
            Free forever for students and graduates. 2 free AI runs each month. No card required.
          </p>
      ...
      <footer className="border-t border-border/60 py-12">
        <div className="mx-auto grid max-w-7xl gap-8 px-5 md:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Where Africa's next generation launches their career.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="#jobs" className="hover:text-accent">
                  Browse jobs
                </a>
              </li>
              <li>
                <a href="#pillars" className="hover:text-accent">
                  Resume review
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="#employers" className="hover:text-accent">
                  Talent network
                </a>
              </li>
            </ul>
        ...
        <p className="mx-auto mt-10 max-w-7xl px-5 text-xs text-muted-foreground">
          &copy; {new Date().getFullYear()} CareerPilot. Made for Africa's next generation of
          professionals.
        </p>
      </footer>
    </div>
